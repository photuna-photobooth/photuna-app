    ...
    <footer className="bg-gray-900 text-gray-300 px-6 py-16">
      <div className="max-w-6xl mx-auto">
        <div className="grid md:grid-cols-4 gap-12 mb-12">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li><a href="#" className="hover:text-white transition">Video Guides</a></li>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li><a href="mailto:admin@studiophotuna.com" className="hover:text-white transition">Contact</a></li>
        ...
        <div className="border-t border-gray-800 pt-8 flex flex-col md:flex-row items-center justify-between text-sm">
          <p>&copy; 2024 Studio Photuna. All rights reserved.</p>
          <p>Made with 📸 for photo booth studios</p>
        </div>
      </div>
    </footer>
  );
